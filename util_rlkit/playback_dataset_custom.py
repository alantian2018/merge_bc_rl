        ...
        if write_video:
            if video_count % video_skip == 0:
                ...
                for cam_name in camera_names:
                    video_img.append(env.render(mode="rgb_array", height=1024, width=1024, camera_name=cam_name))
...
def playback_dataset(args, camera_height=1024, camera_width = 1024):
    # some arg checking
    ...
    if args.render_image_names is None:
        ...
        env_meta['camera_heights']=camera_height
        env_meta['canera_widths']=camera_Width
        print(env_meta)
